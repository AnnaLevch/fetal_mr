...
if __name__ == "__main__":
    base_config = "../../config/config_brain/config_roi_contour_losses_dice.json"
    configs_folder = '../../../log/params_search_FR-FSE_2'
    beta_vals = [0.5, 0.7, 1]
    gamma_vals = [0]
        ...
        for lr in initial_learning_rate_vals:
            for beta in beta_vals:
                for gamma in gamma_vals:
                    ...
                    subprocess.call("python3 -m training.train_scripts.train_params_search_FR-FSE_2 " + args, shell=True)
                    ind = ind + 1