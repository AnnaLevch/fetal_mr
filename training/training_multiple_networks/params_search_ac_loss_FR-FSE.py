...
if __name__ == "__main__":
    base_config = "../../config/config_brain/config_roi_assym_contour_emphesize_ac_loss.json"
    configs_folder = '../../../log/params_search_FR-FSE'
    beta_vals = [1]
    gamma_vals = [0]
    labmda_vals = [3, 4]
    theta_vals = [1, 4, 8, 16]
    initial_learning_rate_vals = [0.00005]
    num_epochs = 10
                ...
                for gamma in gamma_vals:
                    for labmda in labmda_vals:
                        for theta in theta_vals:
                            ...
                            subprocess.call("python3 -m training.train_scripts.train_params_search_FR-FSE " + args, shell=True)
                            ind = ind + 1