...
def get_contour_masks(mask_gt,mask_pred, spacing_mm):
    ...
    # (given a 2x2x2 neighbourhood) according to the spacing_mm
      ...
      return borders_gt, borders_pred, neighbour_code_to_surface_area, neighbour_code_map_gt, neighbour_code_map_pred
...
def compute_surface_distances(mask_gt, mask_pred, spacing_mm):
    ...
    borders_gt, borders_pred, neighbour_code_to_surface_area, neighbour_code_map_gt, neighbour_code_map_pred = get_contour_masks(mask_gt,mask_pred, spacing_mm)
...
def compute_max_surface_distance(surface_distances):
    """
    Computes the maximum surface distance
    :param surface_distances:
    :return: maximum value of surface distance
    """
    return max(max(surface_distances["distances_gt_to_pred"]), max(surface_distances["distances_pred_to_gt"]))
